...
- Prefer short `ageos.dev` download links in release notes:
  - Latest asset base: `https://ageos.dev/download/latest`
  - Version asset base: `https://ageos.dev/download/<tag>`
  - Linux installer: `https://ageos.dev/install.sh`
  - Windows installer: `https://ageos.dev/install.ps1`
- Use versioned filenames in package examples, for example `AgeOS-0.1.0-x64.deb` and `AgeOS-0.1.0-x64.exe`.
